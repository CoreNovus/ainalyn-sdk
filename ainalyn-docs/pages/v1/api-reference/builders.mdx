...
**Parameters:**
- `name` (required) - Agent identifier. Must match pattern `[A-Za-z0-9_-]+`
...
**Parameters:**
- `name` (required) - Workflow identifier. Must match pattern `[A-Za-z0-9_-]+`
...
Workflow names must match pattern: `[A-Za-z0-9_-]+`
...
**Parameters:**
- `name` (required) - Node identifier. Must match pattern `[A-Za-z0-9_-]+`
...
**Note:** Creates directed links via `next_nodes`.
...
**Parameters:**
- `name` (required) - Module identifier. Must match pattern `[A-Za-z0-9_-]+`
...
Module names must match pattern: `[A-Za-z0-9_-]+`
...
**Parameters:**
- `name` (required) - Prompt identifier. Must match pattern `[A-Za-z0-9_-]+`
...
Prompt names must match pattern: `[A-Za-z0-9_-]+`
...
**Parameters:**
- `name` (required) - Tool identifier. Must match pattern `[A-Za-z0-9_-]+`
