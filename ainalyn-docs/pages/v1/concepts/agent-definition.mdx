...
**See**: [Workflows Guide](/v1/guides/workflows/)
...
- [Builders API](/v1/api-reference/builders/) - How to build definitions
- [Validation](/v1/guides/validation/) - Validating definitions
- [Platform Boundaries](/v1/concepts/platform-boundaries/) - What definitions cannot include
- [Your First Agent](/v1/getting-started/your-first-agent/) - Complete tutorial
