...
- [Compiler vs Runtime](/docs/v1/concepts/compiler-not-runtime/) - Deep dive into the paradigm
- [Agent Definition](/docs/v1/concepts/agent-definition/) - What you're actually building
- [Architecture Overview](/docs/v1/concepts/architecture-overview/) - How the SDK is designed
