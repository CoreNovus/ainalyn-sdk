...
The SDK is compiler-first with an optional runtime wrapper for ATOMIC handlers:

| SDK Does | SDK Does NOT Do |
|----------|----------------|
| Validate schema, review gates, and static analysis | Execute workflows |
...
| Wrap ATOMIC handlers (optional) | Decide execution or billing |
...
2. SDK validates schema, review gates, and static analysis, then exports YAML
