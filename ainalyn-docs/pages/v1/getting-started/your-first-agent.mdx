...
AgentBuilder("My@Agent")   # No special symbols

# Correct (use letters/numbers with hyphens or underscores)
AgentBuilder("MyAgent")
AgentBuilder("research_assistant")
```

## Next Steps

- [Platform Boundaries](/v1/concepts/platform-boundaries/) - What the SDK can/cannot do
- [API Reference](/v1/api-reference/builders/) - All builder methods
- [Workflows](/v1/guides/workflows/) - Advanced workflow patterns
- [Modules](/v1/guides/modules/) - Create custom modules

## Need Help?

- [Quickstart](/v1/getting-started/quickstart/) - Simpler example
- [API docs](/v1/api-reference/api/) - Function reference
