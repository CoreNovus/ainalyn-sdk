...
**Valid names:**
```python
"http-client"        # Hyphens ok
"HttpClient"         # Uppercase ok
"data_processor"     # Underscores ok
```
...
"my module"          # No spaces
"http.client"        # No dots
"http@client"        # No special symbols
```
...
- [ModuleBuilder API](/v1/api-reference/builders/#modulebuilder) - Full API reference
- [Prompts Guide](/v1/guides/prompts/) - Using prompt templates
- [Tools Guide](/v1/guides/tools/) - External tool integration
- [Workflows](/v1/guides/workflows/) - Using modules in workflows
