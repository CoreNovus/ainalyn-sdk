...
- [ToolBuilder API](/docs/v1/api-reference/builders/#toolbuilder) - Full API reference
- [Modules Guide](/docs/v1/guides/modules/) - Custom business logic
- [Prompts Guide](/docs/v1/guides/prompts/) - LLM templates
- [Workflows](/docs/v1/guides/workflows/) - Using tools in workflows
