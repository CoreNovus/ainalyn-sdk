...
See [Platform Boundaries](/docs/v1/concepts/platform-boundaries/) for the SDK's role.

## See Also

- [Validation](/docs/v1/guides/validation/) - Validate before export
- [compile_agent() API](/docs/v1/api-reference/api/#compile_agent) - Full API reference
- [Platform Boundaries](/docs/v1/concepts/platform-boundaries/) - SDK vs Platform roles
