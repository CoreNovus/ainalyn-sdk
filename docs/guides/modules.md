...
- [ModuleBuilder API](../api-reference/builders.md#modulebuilder) - Full API reference
- [Prompts Guide](prompts.md) - Using prompt templates
- [Tools Guide](tools.md) - External tool integration
- [Workflows](workflows.md) - Using modules in workflows
