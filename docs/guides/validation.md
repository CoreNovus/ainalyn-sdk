...
- [Error Handling](errors.md) - Builder errors and how to fix them
- [API Reference](../api-reference/api.md) - validate() function details
- [Builders](../api-reference/builders.md) - Builder validation rules
