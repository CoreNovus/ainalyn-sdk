...
```python
# ⚠️ Exports without checking validity
yaml_output = export_yaml(agent)
...
See [Platform Boundaries](../concepts/platform-boundaries.md) for the SDK's role.

## See Also

- [Validation](validation.md) - Validate before export
- [compile_agent() API](../api-reference/api.md#compile_agent) - Full API reference
- [Platform Boundaries](../concepts/platform-boundaries.md) - SDK vs Platform roles
